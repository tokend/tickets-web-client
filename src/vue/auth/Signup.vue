    ...
    <form novalidate @submit.prevent="submit">
      ...
      <div class="auth-page__tips">
        <div class="auth-page__tip">
          ...
          <router-link class="auth-page__tip-link auth-page__tip-link--strong" :to="routes.login">
            {{ i18n.su_sign_in() }}
          </router-link>
        </div>

        <div class="auth-page__tip">
          {{ 'su_continue_as_guest_prefix' | translate }}
          <router-link class="auth-page__tip-link" :to="routes.app">
            {{ 'su_link_continue_as_guest' | translate }}
          </router-link>
        </div>
      </div>
    </form>
