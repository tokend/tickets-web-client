const mutations = {
  ...
  SET_USER_OWNED_TICKETS: 'SET_USER_OWNED_TICKETS',
  SET_USER_ACQUIRED_TICKETS: 'SET_USER_ACQUIRED_TICKETS'
}
...
const getters = {
  ...
  walletNonStatsTokens: 'walletNonStatsTokens',
  ...
  // tickets:
  tickets: 'tickets',
  acquirableTickets: 'acquirableTickets',
  walletTickets: 'walletTickets',
  userOwnedTickets: 'userOwnedTickets',
  userAcquiredTickets: 'userAcquiredTickets',
  userWalletTickets: 'userWalletTickets',
  userTransferableTickets: 'userTransferableTickets',
  userWithdrawableTickets: 'userWithdrawableTickets'
}
