...
import TicketCreation from '../vue/app/ticketCreation/TicketCreation.Entry'
import TicketCreationIndex from '../vue/app/ticketCreation/TicketCreation.Index'
...
import Tickets from '../vue/app/tickets/Tickets.Entry'
import TicketDetails from '../vue/app/tickets/ticket_details/Tickets.Viewer'
import TicketsExplore from '../vue/app/tickets/overview/Tickets.Explore'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          feature_flag: config.FEATURE_FLAGS.ticketCreation,
          name: 'app.ticketCreation',
          path: '/ticket-creation',
          component: TicketCreation,
          redirect: { path: '/ticket-creation/index' },
          children: [
            {
              path: '/ticket-creation/index',
              name: 'ticket-creation.index',
              meta: { pageName: PAGES_NAMES.createTicket },
              component: TicketCreationIndex,
              props: true
            },
            {
              path: '/ticket-creation/index/:id',
              name: 'ticket-creation.index:id',
              meta: { pageName: PAGES_NAMES.createTicket },
              component: TicketCreationIndex,
              props: true
            }
        ...
        {
          feature_flag: config.FEATURE_FLAGS.tickets,
          name: 'app.tickets',
          path: '/tickets',
          component: Tickets,
          redirect: { path: '/tickets/explore' },
          children: [
            {
              path: '/tickets/explore',
              name: 'tickets.explore',
              meta: { pageName: PAGES_NAMES.exploreTickets },
              component: TicketsExplore
            },
            {
...
function inAppRouteGuard (to, from, next) {
  // Here you can add redirection rules for various user statuses
  next()
}
